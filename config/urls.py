...
from core.views import (
    ...
    admin_kanban_view,
    admin_listing_create_view,
    admin_listing_edit_view,
    admin_listing_photo_delete_view,
    admin_listing_photo_upload_view,
    admin_listings_bulk_create_view,
    admin_listings_view,
    admin_quotes_view,
...
urlpatterns = [
    ...
    path('ai-quote/complete/<int:quote_id>/video-upload-url/', quote_video_presigned_url_view, name='quote_video_presigned_url'),
    path('ai-quote/complete/<int:quote_id>/video-confirm/', quote_video_confirm_view, name='quote_video_confirm'),
    ...
    path('admin-dashboard/bulk-pickup/', admin_kanban_bulk_pickup_view, name='admin_kanban_bulk_pickup'),
    ...
    path('admin-dashboard/listings/', admin_listings_view, name='admin_listings'),
    path('admin-dashboard/listings/bulk-create/', admin_listings_bulk_create_view, name='admin_listings_bulk_create'),
    path('admin-dashboard/listings/new/', admin_listing_create_view, name='admin_listing_create'),
    path('admin-dashboard/listings/<int:listing_id>/', admin_listing_edit_view, name='admin_listing_edit'),
    path('admin-dashboard/listings/<int:listing_id>/photos/', admin_listing_photo_upload_view, name='admin_listing_photo_upload'),
    path('admin-dashboard/listings/<int:listing_id>/photos/<int:image_id>/delete/', admin_listing_photo_delete_view, name='admin_listing_photo_delete'),
